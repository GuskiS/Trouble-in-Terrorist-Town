...
new g_iItemID;
new const g_szModels[][] = {"models/v_awp.mdl", "models/p_awp.mdl", "models/w_awp.mdl"};
...
public plugin_precache()
{
	...
	if(!amx_load_setting_string_arr(TTT_SETTINGSFILE, "AWP", "MODEL_V", g_aModels))
	{
	...
	if(!amx_load_setting_string_arr(TTT_SETTINGSFILE, "AWP", "MODEL_P", g_aModels))
	{
	...
	if(!amx_load_setting_string_arr(TTT_SETTINGSFILE, "AWP", "MODEL_W", g_aModels))
	{
